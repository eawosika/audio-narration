(function() {
  ...
  // ── Inject HTML markup ──
  var playerHTML = '<div id="narration-player" style="display:none;font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif;background:#e8e3d5;border:2px solid #111;border-radius:14px;padding:16px 20px;margin-bottom:32px;">'
